	...
	<div class="w3-row">
	  ...
	  <div class="w3-rest">
		<div class="w3-row w3-center">
		  <div class="w3-tiny w3-third" style="background-color:rgba(0,0,0,0.1);">
			<form method="POST" action="">
				<label>Report of:</label>
				<input type="date" name="reportdate" id="reportdate" required value="<?php echo $reportdate;?>" style="height:20px;">
				<input type="submit" value="go" style="height:20px;">
			</form>
		  </div>
		  <div class="w3-small w3-third" style="background-color:rgba(0,0,0,0.2);height:20px;">
			<a href="javascript:void(0)" onclick="document.getElementById('newbill').style.display='block'" class="nodec">New Bill/Request</a>
		  </div>
		  <div class="w3-small w3-third" style="background-color:rgba(0,0,0,0.5);height:20px;">
			Viewing Mode: 
		...
		<div class="w3-row w3-center w3-margin">
			...
			<div class=" w3-twothird " id="record">
				<div class="w3-center w3-responsive w3-card entryreport" id="dailyrecordshow" >
					<?php echo $entrtable; ?>
				</div>
			</div>
		</div>
